...
import com.MAVLink.Messages.CRC;
...
import java.io.Serializable;
        ...
        /**
        * Common interface for all com.MAVLink Messages
        * Packet Anatomy
        ...
        * The checksum is the same as used in ITU X.25 and SAE AS-4 standards (CRC-16-CCITT), documented in SAE AS5669A. Please see the com.MAVLink source code for a documented C-implementation of it. LINK TO CHECKSUM
        ...
        */
        ...
        /**
        * Unpack the data in this packet and return a com.MAVLink message
        *
        * @return com.MAVLink message decoded from this packet
        */
